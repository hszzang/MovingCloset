            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h4 class="mt-4">모여 관리</h4>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">MOYO</li>
                        <!-- 
                                ...
                                <table id="datatablesSimple">
                                    <thead style="text-align:center;">
                                        <tr style="text-align:center;">
                                            ...
                                            <th style="width:3%;">목표인원</th>
                                            <th style="width:10%;">마감일</th>
                                            <th style="width:15%;">설명</th>
                                            <th style="width:10%;">모집시작</th>
                                            <th style="width:10%;">모집마감</th>
                                            <th style="width:5%;">진행상황</th>
                                            <th style="width:5%;">담당버스</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${MoyoList }" var="moyo">
                                        <tr style="text-align:center;">
                                            <td>${moyo.m_idx }</td>
                                            <td>${moyo.m_name }</td>
                                            <td>${moyo.m_addr }</td>
