		...
		<div class="input-form-background row">
			<div class="input-form col-md-12 mx-auto">
				<div class="input-form-wrap">
					<h3>회원가입</h3>
					<form name="registFrm" id="registFrm" action="#" method="post" onsubmit="return loginValdidate(this);"> 
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									<td class="text-left"
										style="vertical-align:middle;">아이디</td>
									<td class="form-inline">
										<input type="text" name="user_id" class="form-control" style="width: 250px;" required/>&nbsp;&nbsp;&nbsp;&nbsp;
										<button type="button" id="checkid" onclick="idCheck(this.form);" style="width: 120px;height: 40px;">중복확인</button>
									</td>
								...
								<tr>
									<td class="text-left"
										style="vertical-align:middle;">비밀번호</td>
									<td>
										<input type="text" name="pass1" class="form-control" style="width: 250px;" required/>
									</td>
								</tr>
								
								<tr>
									<td class="text-left"
										style="vertical-align:middle;">비밀번호 확인</td>
									<td>
										<input type="text" name="pass2" class="form-control" style="width: 250px;" required/>
									</td>
								</tr>
								
								<tr>
									<td class="text-left"
										style="vertical-align:middle;">생년월일</td>
									<td>
										<input type="date" id="birth" name="birth" class="form-control" style="width: 250px;" required />
									</td>
								</tr>
								...
								<tr>
									...
									<td class="form-inline">
										<input type="text" name="postcode" class="form-control" style="width: 250px;" required/>&nbsp;&nbsp;&nbsp;&nbsp;
										<button type="button" id="postBtn" onclick="zipcodeFind();" style="width: 120px;height: 40px;">우편번호</button>
									</td>
								...
								<tr>
									...
									<td>
										<input type="text" name="addr1" class="form-control" style="width: 500px;" required />&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="text" name="addr2" class="form-control" style="width: 500px;" required placeholder="상세주소를 입력해주세요."/>
								...
								<tr>
									...
									<td class="form-inline" >
										...
										<select name="email_domain" class="form-control" onChange="inputEmail(this.form);" style="width:30%;">
								...
								<tr >
									<td class="text-left"
										style="vertical-align:middle;" >관심 태그</td>
									<td class="form-inline" style="padding-bottom: 0px;">
										<input type="checkbox" name="tag1" class="form-control"  /> &nbsp;댄디&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="tag1" class="form-control"  /> &nbsp;클래식&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="tag1" class="form-control"  /> &nbsp;캐주얼&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="tag1" class="form-control"  /> &nbsp;스포티&nbsp;&nbsp;&nbsp;&nbsp;
									</td> 
								</tr>
								<tr >
									<td class="text-left"
									...
									<td class="form-inline" style="padding-top: 0px;">
										<input type="checkbox" name="tag1" class="form-control"  /> &nbsp;모던&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="tag1" class="form-control"  /> &nbsp;스트릿&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="tag1" class="form-control"  /> &nbsp;빈티지&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="tag1" class="form-control"  /> &nbsp;러블리&nbsp;&nbsp;&nbsp;&nbsp;
