						...
						<div class="input-form-wrap">
							...
							<form id="overlapFrm" name="overlapFrm">
								<input type="hidden" name="user_id" value="${param.user_id }"
									...
									class="btn btn-primary btn-lg btn-block" id="idsubmitBtn"
									value="아이디 사용하기" onclick="idUse2();" />
							</form>
						</div>
					</div>
				</div>
				...
				<div class="input-form-background row">
					<div class="input-form col-md-12 mx-auto">
						<div class="input-form-wrap">
							...
							<form id="overlapFrm" name="overlapFrm"
								onsubmit="return idUse(this.form);">
								<input type="text" name="user_id" size="20" class="form-control"
									style="width: 250px;" placeholder="아이디를 입력해주세요." /> <br>
								<input type="submit" class="btn btn-primary btn-lg btn-block"
									id="idsubmitBtn" value="아이디사용하기" />
							</form>
						</div>
					</div>
				</div>
